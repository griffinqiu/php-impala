    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        4 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Apache\Hadoop\Hive\FieldSchema',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Apache\Hadoop\Hive\FieldSchema();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'hiveObject',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\HiveObjectRef',
          ),
        2 => array(
          'var' => 'principalName',
          'type' => TType::STRING,
        ...
        4 => array(
          'var' => 'grantInfo',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\PrivilegeGrantInfo',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->hiveObject = new \Apache\Hadoop\Hive\HiveObjectRef();
        ...
        case 4:
          if ($ftype == TType::STRUCT) {
            $this->grantInfo = new \Apache\Hadoop\Hive\PrivilegeGrantInfo();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Apache\Hadoop\Hive\HiveObjectPrivilege',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Apache\Hadoop\Hive\HiveObjectPrivilege();
        ...
        case 1:
          if ($ftype == TType::MAP) {
            ...
            for ($_i25 = 0; $_i25 < $_size21; ++$_i25)
            {
              ...
              {
                $elem33 = null;
                $elem33 = new \Apache\Hadoop\Hive\PrivilegeGrantInfo();
        ...
        case 2:
          if ($ftype == TType::MAP) {
            ...
            for ($_i38 = 0; $_i38 < $_size34; ++$_i38)
            {
              ...
              {
                $elem46 = null;
                $elem46 = new \Apache\Hadoop\Hive\PrivilegeGrantInfo();
        ...
        case 3:
          if ($ftype == TType::MAP) {
            ...
            for ($_i51 = 0; $_i51 < $_size47; ++$_i51)
            {
              ...
              {
                $elem59 = null;
                $elem59 = new \Apache\Hadoop\Hive\PrivilegeGrantInfo();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        5 => array(
          'var' => 'privileges',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\PrincipalPrivilegeSet',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 5:
          if ($ftype == TType::STRUCT) {
            $this->privileges = new \Apache\Hadoop\Hive\PrincipalPrivilegeSet();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        7 => array(
          'var' => 'serdeInfo',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\SerDeInfo',
          ),
        8 => array(
          'var' => 'bucketCols',
          'type' => TType::LST,
        ...
        9 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Apache\Hadoop\Hive\Order',
            ),
          ),
        10 => array(
          'var' => 'parameters',
        ...
        11 => array(
          'var' => 'skewedInfo',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\SkewedInfo',
          ),
        12 => array(
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem129 = null;
              $elem129 = new \Apache\Hadoop\Hive\FieldSchema();
        ...
        case 7:
          if ($ftype == TType::STRUCT) {
            $this->serdeInfo = new \Apache\Hadoop\Hive\SerDeInfo();
        ...
        case 9:
          if ($ftype == TType::LST) {
            ...
            {
              $elem141 = null;
              $elem141 = new \Apache\Hadoop\Hive\Order();
        ...
        case 11:
          if ($ftype == TType::STRUCT) {
            $this->skewedInfo = new \Apache\Hadoop\Hive\SkewedInfo();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        7 => array(
          'var' => 'sd',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\StorageDescriptor',
          ),
        8 => array(
          'var' => 'partitionKeys',
          'type' => TType::LST,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 7:
          if ($ftype == TType::STRUCT) {
            $this->sd = new \Apache\Hadoop\Hive\StorageDescriptor();
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem159 = null;
              $elem159 = new \Apache\Hadoop\Hive\FieldSchema();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'booleanStats',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\BooleanColumnStatsData',
          ),
        2 => array(
          'var' => 'longStats',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\LongColumnStatsData',
          ),
        3 => array(
          'var' => 'doubleStats',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\DoubleColumnStatsData',
          ),
        4 => array(
          'var' => 'stringStats',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\StringColumnStatsData',
          ),
        5 => array(
          'var' => 'binaryStats',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\BinaryColumnStatsData',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->booleanStats = new \Apache\Hadoop\Hive\BooleanColumnStatsData();
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->longStats = new \Apache\Hadoop\Hive\LongColumnStatsData();
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->doubleStats = new \Apache\Hadoop\Hive\DoubleColumnStatsData();
        ...
        case 4:
          if ($ftype == TType::STRUCT) {
            $this->stringStats = new \Apache\Hadoop\Hive\StringColumnStatsData();
        ...
        case 5:
          if ($ftype == TType::STRUCT) {
            $this->binaryStats = new \Apache\Hadoop\Hive\BinaryColumnStatsData();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'statsData',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\ColumnStatisticsData',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->statsData = new \Apache\Hadoop\Hive\ColumnStatisticsData();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'statsDesc',
          'type' => TType::STRUCT,
          'class' => '\Apache\Hadoop\Hive\ColumnStatisticsDesc',
          ),
        2 => array(
          'var' => 'statsObj',
          'type' => TType::LST,
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Apache\Hadoop\Hive\ColumnStatisticsObj',
            ),
          ),
        );
    }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->statsDesc = new \Apache\Hadoop\Hive\ColumnStatisticsDesc();
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem200 = null;
              $elem200 = new \Apache\Hadoop\Hive\ColumnStatisticsObj();
